...
export const listFiles = tool(
    async ({ }) => {
        ...
        const response = await axios.get("http://019e7847-134f-7139-80d9-671d555f7dcc.agent.localhost/list-files")
...
export const readFiles = tool(
    async ({ files: [] }) => {
        ...
        const response = await axios.get("http://019e7847-134f-7139-80d9-671d555f7dcc.agent.localhost/read-files?files=" + files.join(","))
...
export const updateFiles = tool(
    async ({ files }) => {
        ...
        const response = await axios.patch("http://019e7847-134f-7139-80d9-671d555f7dcc.agent.localhost/update-files", {
            updates: files
        })
        console.log("=================================")
